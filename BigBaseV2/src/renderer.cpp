...
namespace big
{
		...
		m_dxgi_swapchain(*g_pointers->m_swapchain)
	{
		...
		m_iconfont = ImGui::GetIO().Fonts->AddFontFromFileTTF("C:\\Spectrum\\Font\\Icons.ttf", 30.0f);
		LOG_INFO("Font Loaded");
		m_iconfont2 = ImGui::GetIO().Fonts->AddFontFromFileTTF("C:\\Spectrum\\Font\\Icons.ttf", 26.0f);
		LOG_INFO("Font Loaded");
		g_gui.dx_init();
		g_renderer = this;
	}
